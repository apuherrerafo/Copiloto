...
export default function EntrarPage() {
  ...
  async function handleGoogle() {
    ...
    try {
      ...
      setErr('No se pudo abrir el inicio de sesión. Revisa las variables de entorno (Google + NextAuth).');
      setBusy(false);
    }
  }
  ...
  return (
    <div className="min-h-screen bg-background flex flex-col">
      ...
      >
        ...
        <div className="flex-1 px-6 pt-2 pb-10 flex flex-col justify-end gap-3">
          ...
          <p className="text-[10px] text-muted/80 text-center leading-relaxed">
            Tus registros de salud siguen en este dispositivo (IndexedDB). La cuenta solo identifica quién eres.
          </p>
        </div>
      </motion.div>
    </div>
